...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		// label "title"
		JLabel lblTitle = new JLabel("JAISON'S Currency Converter");
		...
		// label "version"
		JLabel lblVersion = new JLabel("Version 2.0.5");
